...
class DeviceData {
    ...
    let errorDevice = [
        ...
        Error(errorCode: 71, errorText: "Датчик извлечения банкноты PSDxx загрязнен или неисправен сенсор прижима (х = 1 - 6)", errorFix: "Обратитесь в  сервисную службу.", errorPictire: "CMD", device_id: .CMD),
        Error(errorCode: 81, errorText: "Датчик опорожнения кассеты PSEx загрязнен (х = 1 - 6)", errorFix: "Обратитесь в  сервисную службу.", errorPictire: "CMD", device_id: .CMD),
