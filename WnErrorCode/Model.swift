...
class DeviceData {
    ...
    let errorDevice = [
        ...
        Error(errorCode: 95, errorText: "Оптический датчик PS27 загрязнен", errorPictire: "1.png", device_id: .CMD),
        ...
        Error(errorCode: 24, errorText: "Распознано застревание купюр во время их отделения", errorPictire: "2.png", device_id: .CCMD)
    ]
